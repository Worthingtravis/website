...
export const AnimatedBorderGradient = ({
  ...
  return (
    ...
    >
      ...
      <span className="conic-gradient absolute z-0 flex gap-2 " />
      <div className="z-[1] inline-flex h-full w-full items-center justify-center rounded-xl bg-slate-950  py-1 text-sm font-medium text-white backdrop-blur-3xl" />
    </span>
  );
};
