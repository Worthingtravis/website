...
export const AboutSection = () => {
  return (
    ...
    >
      ...
      <FadeIn delay={0.4} className="mt-16 grid grid-cols-1 gap-8 md:grid-cols-3">
        {/* Service 1 */}
        <div 
          className="rounded-xl border border-gray-700/50 bg-gray-800/50 p-6 backdrop-blur-sm transition-colors duration-300 hover:border-cyan-500/50"
          role="article"
        >
